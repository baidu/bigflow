...
#ifndef FLUME_RUNTIME_SPARK_CACHE_INPUT_EXECUTOR_H
#define FLUME_RUNTIME_SPARK_CACHE_INPUT_EXECUTOR_H
...
class CacheInputExecutor : public InputExecutor {
public:
    explicit CacheInputExecutor(const PbSparkTask::PbCacheInput& message);
    virtual ~CacheInputExecutor() {}
...
private:
    ...
    const PbSparkTask::PbCacheInput _message;
};
...
#endif  // FLUME_RUNTIME_SPARK_CACHE_INPUT_EXECUTOR_H
