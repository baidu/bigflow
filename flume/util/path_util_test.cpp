...
TEST(TestGetToftStylePath, CaseAll) {
    ...
    ASSERT_EQ("/hdfs/a.b.com:123?username=test,password=test/x/1",
        GetToftStylePath("hdfs://a.b.com:123/x/1", conf));
    ASSERT_EQ("/hdfs/baidu.com:1234?username=test,password=test/x/1",
    ...
    ASSERT_EQ(
        "/hdfs/baidu.com:1234?username=test,password=test/app/test",
