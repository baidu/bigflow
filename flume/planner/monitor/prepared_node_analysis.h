...
#ifndef FLUME_PLANNER_MONITOR_PREPARED_NODE_ANALYSIS_H_
#define FLUME_PLANNER_MONITOR_PREPARED_NODE_ANALYSIS_H_
...
class PreparedNodeAnalysis : public Pass {
    HOLD_BY_DEFAULT()
    RELY_PASS(PreparedNodeBasicAnalysis)
    PRESERVE_BY_DEFAULT()
public:
    virtual ~PreparedNodeAnalysis() {}
...
#endif // FLUME_PLANNER_MONITOR_PREPARED_NODE_ANALYSIS_H_
