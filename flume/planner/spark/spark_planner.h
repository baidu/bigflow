...
#ifndef FLUME_PLANNER_SPARK_SPARK_PLANNER_H
#define FLUME_PLANNER_SPARK_SPARK_PLANNER_H
...
class SparkPlanner {
public:
    SparkPlanner() : _session(NULL), _job_config(NULL), _entry(NULL) {}

    SparkPlanner(runtime::Session *session, PbJobConfig *job_config);
...
#endif  // FLUME_PLANNER_LOCAL_LOCAL_PLANNER_H
