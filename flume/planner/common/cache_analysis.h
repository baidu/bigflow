...
//
#ifndef FLUME_PLANNER_COMMON_CACHE_ANALYSIS_H_
#define FLUME_PLANNER_COMMON_CACHE_ANALYSIS_H_
...
class CacheAnalysis : public Pass {
    HOLD_BY_DEFAULT();
    PRESERVE_BY_DEFAULT();
    RELY_PASS(SessionAnalysis);
...
#endif // FLUME_PLANNER_COMMON_CACHE_ANALYSIS_H_
