...
#ifndef BIGFLOW_PYTHON_AGGREGATE_PROCESSOR_H_
#define BIGFLOW_PYTHON_AGGREGATE_PROCESSOR_H_
...
typedef AccumulateProcessor AggregateProcessor;

}  // namespace python
}  // namespace bigflow
}  // namespace baidu

#endif  // BIGFLOW_PYTHON_AGGREGATE_PROCESSOR_H_
