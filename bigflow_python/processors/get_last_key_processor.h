...
/**
* @created:     2015/07/03
* @filename:    get_last_key_processor.h
* @author:      fangjun02@baidu.com
* @brief:       get last key processor implementation
*/

#ifndef BIGFLOW_PYTHON_GET_LAST_KEY_PROCESSOR_H_
#define BIGFLOW_PYTHON_GET_LAST_KEY_PROCESSOR_H_
...
class GetLastKeyProcessor : public Processor {
public:
    GetLastKeyProcessor() {}
    virtual ~GetLastKeyProcessor() {}
...
private:
    toft::scoped_ptr<PyFunctorCaller> _deserialize;
...
#endif // BIGFLOW_PYTHON_GET_LAST_KEY_PROCESSOR_H_
