...
#ifndef BIGFLOW_PYTHON_ACCUMULATE_PROCESSOR_H_
#define BIGFLOW_PYTHON_ACCUMULATE_PROCESSOR_H_
...
class AccumulateProcessor : public Processor{
public:
...
private:
    toft::scoped_ptr<PyFunctorCaller> _zero_fn;
...
#endif  // BIGFLOW_PYTHON_ACCUMULATE_PROCESSOR_H_
