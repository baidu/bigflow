...
#ifndef BIGFLOW_PYTHON_DICT_SERDE_H_
#define BIGFLOW_PYTHON_DICT_SERDE_H_
...
class DictSerde : public PythonObjector {
public:
    DictSerde(){}
    virtual ~DictSerde(){
        if (_serde != NULL) {
...
private:
    boost::python::object _dict_key_type;
    boost::python::object _dict_val_type;
    boost::python::object _tp_serde;
...
#endif  // BIGFLOW_PYTHON_DICT_SERDE_H_
